...
Ru: 
- Rogalik-ZombieAI: это мини-рогалик, созданный с помощью геймпада Dart и нейронной сети. Игра создана для изучения возможности создания игры, похожей на CDDA (Cataclysm: Dark Days Ahead), с использованием ИИ (как видите, я столкнулся с технической проблемой). Я предоставил исходный код для компиляции и использования.
- Перед запуском скопируйте игру с сайта, потому что я ленивый засранец :>
